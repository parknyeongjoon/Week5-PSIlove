...
public:
    ...
    void SetVertexBuffer(ID3D11Buffer* InVertexBuffer, const uint32 InStride, const D3D11_PRIMITIVE_TOPOLOGY InTopology) { VertexBuffer = InVertexBuffer; Stride = InStride; Topology = InTopology; }
